...
flow graph in flat format returned by @c(parse-expr). @c(Graph) is an
internal representation of an expression in the form of parallel
assignment statements.  @c(Db) is a database of known functions and
@c(top) is the top type of your type system. This function returns an
